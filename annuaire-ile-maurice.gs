...
const CATEGORIES = [
  ...
  { mot: 'sports club',                          categorie: 'activites', theme: 'complexes-sportifs' },
  { mot: 'gym fitness centre',                   categorie: 'activites', theme: 'complexes-sportifs' },
  { mot: 'salle de sport',                       categorie: 'activites', theme: 'complexes-sportifs' },
  { mot: 'padel club',                           categorie: 'activites', theme: 'complexes-sportifs' },
  { mot: 'tennis club',                          categorie: 'activites', theme: 'complexes-sportifs' },
  { mot: 'terrain de sport municipal',           categorie: 'activites', theme: 'complexes-sportifs' },
