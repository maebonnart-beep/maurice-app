...
export const SELECTIONS: Selection[] = [
  ...
  },
  {
    id: "tortues-geantes",
    emoji: "🐢",
    title: "Je veux voir des tortues géantes",
    ...
    businessIds: [
      ...
      "ile-aux-aigrettes",
      "vallee-d-osterlog-endemic-garden",
      "valle-advenature-park-formerly-la-vallee-des-couleurs",
      "refuge-animalier-gros-cailloux",
      "parc-animalier-maritim-resort-balaclava",
    ],
  },
  {
    id: "pepites-secretes",
  ...
  {
    id: "envie-de-prendre-du-temps-pour-soi",
    emoji: "🧖‍♀️",
    title: "Envie de prendre du temps pour soi",
    ...
    businessIds: [
      ...
      "angsana-spa-and-wellness-centre",
      "allure-coiffure-port-louis",
      "five-elements-spa",
      "yoga-plus-centre-soins",
      "om-spa",
      "the-pilates-and-yoga-studio-soins",
      "coiffeur-sooren-coiffure",
      "lux-me-spa",
    ],
  },
  {
  ...
  {
    id: "occuper-vacances-enfants",
    emoji: "🏕️",
    title: "Occuper les vacances des enfants",
    tagline: "Camps, parcs d'aventure, cinémas, bowling... de quoi occuper petits et grands pendant les vacances scolaires",
    group: "famille",
    icon: "Sparkle",
    ...
    businessIds: [
      ...
      "splash-n-fun-quatre-cocos",
      "mcine-tribeca",
      "mcine-port-louis-caudan",
      "le-lucky-strike-bowling-lounge",
      "gravity-max-tribeca-mall",
    ],
  },
  {
  ...
  },
  {
    ...
    group: "manze",
    icon: "ForkKnife",
    photoUrl: "https://images.pexels.com/photos/6068717/pexels-photo-6068717.jpeg?auto=compress&cs=tinysrgb&w=800",
    photoCredit: "Dario Garcia / Pexels",
    businessIds: [
  ...
  {
    id: "poisson-fruits-de-mer",
    emoji: "🦞",
    title: "Où manger du poisson frais et des fruits de mer",
    tagline: "Langouste grillée, curry de poulpe et pêche du jour, du nord au sud",
    group: "manze",
    icon: "ForkKnife",
    photoUrl: "https://images.pexels.com/photos/566343/pexels-photo-566343.jpeg?auto=compress&cs=tinysrgb&w=800",
    photoCredit: "Sollie Foto / Pexels",
    businessIds: [
      "amigo-restaurant-cap-malheureux",
      "restaurant-kanaco",
      "cabane-du-filao",
      "l-espadon-restaurant",
      "lecapitaine-restaurant",
      "le-pescatore",
      "sugar-restaurant-bar",
      "eldorade-resto-bar",
      "le-batelage",
      "pearl-fisher",
      "taste-of-freedom",
      "chez-rosy-gris-gris-souillac",
      "la-case-poisson-trou-eau-douce",
      "fish-market",
      "west-coast-seafood",
    ],
  },
  {
    id: "ou-manger-des-burgers",
    emoji: "🍔",
    title: "Où manger des burgers",
    tagline: "Smash burgers, burgers gourmets et roulottes de plage, du nord au sud",
    group: "manze",
    icon: "ForkKnife",
    photoUrl: "https://images.pexels.com/photos/15010285/pexels-photo-15010285.jpeg?auto=compress&cs=tinysrgb&w=800",
    photoCredit: "Natan Machado Fotografia Gastronômica / Pexels",
    businessIds: [
      "seb-s-kitchen-grand-baie",
      "beach-house-restaurant-bar",
      "jeanno-burger-flic-en-flac",
      "smasher-tamarin",
      "maravann-burgers",
      "esco-burger-blue-bay",
      "beyond-burgers",
      "blacksheep-ebene",
      "cozy-burger",
      "dalon-grand-baie",
  ...
  {
    id: "ou-manger-les-meilleures-boulettes",
    emoji: "🥟",
    title: "Où manger les meilleures boulettes ?",
    tagline: "Boulettes et raviolis chinois, des cantines de rue aux tables cantonaises",
    group: "manze",
    icon: "ForkKnife",
    photoUrl: "https://images.pexels.com/photos/15220879/pexels-photo-15220879.jpeg?auto=compress&cs=tinysrgb&w=800",
    photoCredit: "Alina Skazka / Pexels",
    businessIds: [
      "ti-kouloir",
      "restaurant-l-empereur",
      "les-alizes",
      "sunset-snack",
      "ti-kabann",
      "yes-food-moris",
